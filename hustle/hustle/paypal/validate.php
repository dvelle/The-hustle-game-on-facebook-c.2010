...
mail("dvelle@yahoo.com","Paypal check","We cannot verify your purchase<br/>".$req."<br/>");
...
if(isset($ppHost))
{
	...
	{      
		...
		{   
			...
			mail("dvelle@yahoo.com","Paypal Good","We cannot verify your purchase<br/>".$req."<br/>");
				$valid = true;   
			}elseif (strcmp ($res, "INVALID") == 0){
			mail("dvelle@yahoo.com","Paypal Error","We cannot verify your purchase<br/>".$req."<br/>");
				$valid = false;   
			}
		}   
		fclose ($fp);   
