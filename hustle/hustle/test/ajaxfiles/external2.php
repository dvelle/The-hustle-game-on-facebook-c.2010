...
<div class="TabbedPanelsContent">
		...
		//Part 2
		$query = "SELECT COUNT(*) FROM arcade_games WHERE categoryid = '2' ";
		...
		while($result_ar = mysql_fetch_assoc($result)){
            ...
            <tr>
				...
				echo "<br />";
				$file = $result_ar['file']; $width = $result_ar['width']; $height = $result_ar['height']; echo"<a href=http://www.12daysoffun.com/hustle/test/gamescreen.php?game=$file&amp;width=$width&amp;height=$height target='_parent'>PLAY</a>"; 
				?></td>
                <td><?php echo " "; ?></td>
                <td><?php echo " "; ?></td>
