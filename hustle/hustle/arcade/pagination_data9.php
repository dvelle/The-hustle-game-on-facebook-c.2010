...
//get table contents
$start = ($page-1)*10;
$sql = "SELECT * FROM arcade_games WHERE categoryid = '9' ORDER BY gameid LIMIT $start,$per_page";
...
?>
	...
	<table width="800px">
		...
		<?php
		//Print the contents"<a href=\"javascript:ajaxpage('../arcade/gamescreen.php?game=$file&amp;width=$width&amp;height=$height', 'content');\">PLAY</a>"
		$i = 0;
