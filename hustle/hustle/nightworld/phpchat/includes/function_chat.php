...
function index_logo()
{
	echo '<div id=\'logo\' class="logo"><a href="http://www.123flashchat.php"><img src="theme/img/logo.gif"  border="0"  width="243" height="98" /></a></div>';
}
...
function check_install($installing,$GET)
{
	...
	//install initialize
		...
		<div class="instruction_c">
		  <div class="instruction_n">123 Flash Chat PHP chat 3rd party module can make your website have its own flash chat room. It also can integrate your website with databases through simple configuration. It is a totally free third party plug-in component.<br />
			<br />
			<span>Module Support:<br/>
			  www.123flashchat.com-&gt;Support Topic<br/>
			  www.topcmm.com-&gt;Support Helpdesk</span><a href="'.$_SERVER['PHP_SELF'].'?active='.md5('setup').'" ><img src="theme/img/install.gif" width="218" height="61" border="0" />
			  </a></div>
			  </div>
		<div class="instruction_b"><img src="theme/img/kd_left.gif" /><span><!-- space end--></span><img src="theme/img/kd_right.gif" /></div>
		</div>';
...
function textarea()
{
	...
	$textarea = str_replace('</body></html>','',$textarea);
...
function check_chat_url()
{
  ...
  if(!is_numeric($httpHost)&&$httpHost != "localhost"){
     ...
     return 'http://'.$_SERVER['HTTP_HOST'].$php_self;
        ...
        return 'http://your Really Domain'.$php_self;
   }
...
function print_install_completer()
{
   ...
   if(is_file('install/setup.php')) 
   $print_attention = $lang['unmove_install_attention'];
   else
    $print_attention = '';
   ...
   if(is_file('configure/config.php')){
	...
	<div class="cg_d">
	  ...
	  Chat room URL:<br/><br/>
	 '.$chat_url.'<br />
	 <a href="123flashchat.php" target="_blank" >Preview</a>
	 </div>
	...
	echo '
	<p>&nbsp;</p>
	<div class="link" align="center"><a href="http://'.$_SERVER['HTTP_HOST'].'" >Home</a>&nbsp;<b>|</b>&nbsp;<a href="http://www.123flashchat.com/buy.html" target="_blank">Buy</a>&nbsp;<b>|</b>&nbsp;
	<a href="http://www.123flashchat.com" target="_blank">Help</a>&nbsp;<b>|</b>&nbsp;<a href="'.$support_url.'" target="_blank">Support</a></div>';
}
?>